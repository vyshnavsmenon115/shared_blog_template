...
export default function BlogPostPage({ NavbarComponent, FooterComponent, post, searchQuery = '', onSearch, showFeaturedImage = true, ExtraComponent, showPopularPosts = true, popularPostLinks = [], }) {
